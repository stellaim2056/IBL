...
def plot_psth_left_vs_right(spike_raster, times,
    ...
    psth_left_smooth = gaussian_filter1d(psth_left, sigma=100)
    psth_right_smooth = gaussian_filter1d(psth_right, sigma=100)
    ...
    ax.set_title("[{brain_acronym}] PSTH - Left vs Right ({cluster_label})")
    ax.legend()
...
def plot_psth_correct_vs_incorrect(spike_raster, times,
    ...
    ax.set_xlabel('Time (s)')
    ax.set_ylabel('Firing rate (Hz)')
    ax.set_title("[{brain_acronym}] PSTH - Correct vs Incorrect ({cluster_label})")
    ax.legend()
...
def plot_psth_left_correct_vs_left_incorrect(spike_raster, times,
    ...
    ax.set_xlabel('Time (s)')
    ax.set_ylabel('Firing rate (Hz)')
    ax.set_title("[{brain_acronym}] PSTH - Left correct vs Left incorrect ({cluster_label})")
    ax.legend()
...
def plot_psth_right_correct_vs_right_incorrect(spike_raster, times,
    ...
    ax.set_xlabel('Time (s)')
    ax.set_ylabel('Firing rate (Hz)')
    ax.set_title("[{brain_acronym}] PSTH - Rigth correct vs Right incorrect ({cluster_label})")
    ax.legend()
